...
<head>
    ...
    <link rel="canonical" href="<?= $url ?>/settings" />
    ...
    <meta property="og:url" content=" <?= $url ?>/settings" />
    ...
    <meta name="twitter:url" content="<?= $url ?>/settings" />
    <?php echo $header ?>
    <title>Setting & Help |
        <?= $mainTitle ?>
    </title>
                ...
                <div class="lg:grid lg:grid-cols-6 lg:gap-4 w-full">
                    ...
                    <div class="lg:col-span-4 w-full">
                        <div
                            ...
                            <!-- forms  -->
                            <div class="flex flex-col w-full items-start justify-start mainFormClass">
                                <div
