...
var rt = /* @__PURE__ */ ((s) => (s.VERBOSE = "VERBOSE", s.INFO = "INFO", s.WARN = "WARN", s.ERROR = "ERROR", s))(rt || {});
const B = {
  BACKSPACE: 8,
  TAB: 9,
  ENTER: 13,
...
function ke(s, e, t = "log", o, i = "color: inherit") {
  ...
  o && r.push(o);
  const a = "Editor.js 2.29.0-rc.1", l = `line-height: 1em;
            color: #006FEA;
...
const L = ke.bind(window, !1), X = ke.bind(window, !0);
function ie(s) {
...
function Me(s, ...e) {
  ...
  if (z(s) && z(t))
    for (const o in t)
      z(t[o]) ? (s[o] || Object.assign(s, { [o]: {} }), Me(s[o], t[o])) : Object.assign(s, { [o]: t[o] });
  return Me(s, ...e);
}
function Fe(s) {
  const e = $t();
...
class d {
  ...
  static findAllInputs(e) {
    return lt(e.querySelectorAll(d.allInputsSelector)).reduce((t, o) => d.isNativeInput(o) || d.containsOnlyInlineElements(o) ? [...t, o] : [...t, ...d.getDeepestBlockElements(o)], []);
  }
  /**
...
class Ee {
   ...
   */
  emit(e, t) {
    q(this.subscribers) || !this.subscribers[e] || this.subscribers[e].reduce((o, i) => {
      const n = i(o);
      return n !== void 0 ? n : o;
    }, t);
  }
...
function eo(s, e) {
  ...
  return D(t) ? t(s) : Q(t) ? s[t] : (t !== void 0 && L("Conversion «export» property must be a string or function. String means key of saved data object to export. Function should export processed string to export."), "");
}
function to(s, e) {
...
var Z = /* @__PURE__ */ ((s) => (s.APPEND_CALLBACK = "appendCallback", s.RENDERED = "rendered", s.MOVED = "moved", s.UPDATED = "updated", s.REMOVED = "removed", s.ON_PASTE = "onPaste", s))(Z || {});
class F extends Ee {
  /**
   ...
   */
  get data() {
    return this.save().then((e) => e && !q(e.data) ? e.data : {});
  }
  /**
  ...
  set selected(e) {
    ...
    (t || o) && ((i = this.editorEventBus) == null || i.emit(pt, { state: e }), t ? m.addFakeCursor() : m.removeFakeCursor(this.holder), (n = this.editorEventBus) == null || n.emit(ft, { state: e }));
  }
  /**
  ...
  watchBlockMutations() {
    ...
    this.redactorDomChangedCallback = (t) => {
      const { mutations: o } = t, i = o.some((n) => Qt(n, this.toolRenderedElement));
      this.name === "header" && console.log("mutationBelongsToBlock", i, o), i && this.didMutated(o);
...
class oo extends T {
  ...
  getById(e) {
    const t = this.Editor.BlockManager.getBlockById(e);
    return t === void 0 ? (X("There is no block with id `" + e + "`", "warn"), null) : new te(t);
  }
  /**
...
`);
        ...
        for (var E = 0; E < b.length; E++) {
          ...
          if (O) {
            ...
            for (; S < C.parts.length; S++)
              O.parts.push(x(C.parts[S], g));
          } else {
            var H = [];
            for (S = 0; S < C.parts.length; S++)
              H.push(x(C.parts[S], g));
      ...
      function v(b, g) {
        for (var E = [], C = {}, O = 0; O < b.length; O++) {
          ...
          C[H] ? C[H].parts.push(M) : E.push(C[H] = { id: H, parts: [M] });
        }
        return E;
      }
      function A(b, g) {
...
`);
      ...
      function x(b, g) {
        ...
        if (g.singleton) {
          var H = h++;
          E = u || (u = _(g)), C = R.bind(null, E, H, !1), O = R.bind(null, E, H, !0);
        } else
          b.sourceMap && typeof URL == "function" && typeof URL.createObjectURL == "function" && typeof URL.revokeObjectURL == "function" && typeof Blob == "function" && typeof btoa == "function" ? (E = function(M) {
            ...
            return M.attrs.type === void 0 && (M.attrs.type = "text/css"), M.attrs.rel = "stylesheet", y(Y, M.attrs), A(M, Y), Y;
          }(g), C = function(M, Y, de) {
            var ee = de.css, Ce = de.sourceMap, At = Y.convertToAbsoluteUrls === void 0 && Ce;
            (Y.convertToAbsoluteUrls || At) && (ee = k(ee)), Ce && (ee += `
/*# sourceMappingURL=data:application/json;base64,` + btoa(unescape(encodeURIComponent(JSON.stringify(Ce)))) + " */");
            var _t = new Blob([ee], { type: "text/css" }), Ge = M.href;
            M.href = URL.createObjectURL(_t), Ge && URL.revokeObjectURL(Ge);
          }.bind(null, E, g), O = function() {
            N(E), E.href && URL.revokeObjectURL(E.href);
          }) : (E = _(g), C = function(M, Y) {
            var de = Y.css, ee = Y.media;
            if (ee && M.setAttribute("media", ee), M.styleSheet)
      ...
      t.exports = function(b, g) {
        ...
        return p(E, g), function(C) {
          ...
          for (C && p(v(C, g), g), S = 0; S < O.length; S++) {
            var M;
            if ((M = O[S]).refs === 0) {
...
function gt(s, e) {
  return s.map((t) => {
    ...
    return q(o) || (t.data = ze(t.data, o)), t;
  });
}
function G(s, e = {}) {
  const t = {
...
function ze(s, e) {
  return Array.isArray(s) ? bo(s, e) : z(s) ? mo(s, e) : Q(s) ? ko(s, e) : s;
}
function bo(s, e) {
...
function bt(s, e) {
  ...
  return Object.entries(s).forEach(([o, i]) => {
    if (z(i)) {
      const n = e ? `${e}.${o}` : o;
      Object.values(i).every((a) => Q(a)) ? t[o] = n : t[o] = bt(i, n);
      return;
    }
    t[o] = i;
  }), t;
...
const he = class {
  ...
  leafNodesAndReturnIndex(s) {
    if (this.items.length === 0)
      return this.cursor;
    let e = this.cursor;
    return e === -1 ? e = s === he.directions.RIGHT ? -1 : 0 : this.items[e].classList.remove(this.focusedCssClass), s === he.directions.RIGHT ? e = (e + 1) % this.items.length : e = (this.items.length + e - 1) % this.items.length, d.canSetCaret(this.items[e]) && ge(() => m.setCursor(this.items[e]), 50)(), this.items[e].classList.add(this.focusedCssClass), e;
  }
};
let se = he;
se.directions = {
...
class J {
  ...
  constructor(e) {
    ...
    }, this.iterator = new se(e.items, e.focusedItemClass), this.activateCallback = e.activateCallback, this.allowedKeys = e.allowedKeys || J.usedKeys;
  }
  /**
...
var Uo = Object.defineProperty, $o = Object.getOwnPropertyDescriptor, Wo = (s, e, t, o) => {
  for (var i = o > 1 ? void 0 : o ? $o(e, t) : e, n = s.length - 1, r; n >= 0; n--)
    (r = s[n]) && (i = (o ? r(e, t, i) : r(i)) || i);
  return o && i && Uo(e, t, i), i;
}, me = /* @__PURE__ */ ((s) => (s.Close = "close", s))(me || {});
const j = class extends Ee {
   ...
   */
  hide() {
    this.nodes.popover.classList.remove(j.CSS.popoverOpened), this.nodes.popover.classList.remove(j.CSS.popoverOpenTop), this.nodes.overlay.classList.add(j.CSS.overlayHidden), this.flipper.deactivate(), this.items.forEach((s) => s.reset()), this.search !== void 0 && this.search.clear(), oe() && this.scrollLocker.unlock(), this.emit(
      "close"
      /* Close */
    );
  }
...
class K extends T {
  ...
  make() {
    ...
    const e = d.make("div", K.CSS.conversionToolbarLabel, {
  ...
  open() {
    this.filterTools(), this.opened = !0, this.nodes.wrapper.classList.add(K.CSS.conversionToolbarShowed), window.requestAnimationFrame(() => {
      this.flipper.activate(this.tools.map((e) => e.button).filter((e) => !e.classList.contains(K.CSS.conversionToolHidden))), this.flipper.focusFirst(), D(this.togglingCallback) && this.togglingCallback(!0);
    });
  }
  /**
   ...
   */
  close() {
    this.opened = !1, this.flipper.deactivate(), this.nodes.wrapper.classList.remove(K.CSS.conversionToolbarShowed), D(this.togglingCallback) && this.togglingCallback(!1);
  }
  /**
  ...
  addTool(e, t) {
    var r;
    const o = d.make("div", [K.CSS.conversionTool]), i = d.make("div", [K.CSS.conversionToolIcon]);
    o.dataset.tool = e, i.innerHTML = t.icon, d.append(o, i), d.append(o, d.text(W.t(V.toolNames, t.title || ae(e))));
    const n = (r = this.Editor.Tools.blockTools.get(e)) == null ? void 0 : r.shortcut;
    if (n) {
      const a = d.make("span", K.CSS.conversionToolSecondaryLabel, {
        innerText: Fe(n)
      });
      d.append(o, a);
    }
  ...
  async filterTools() {
    ...
    this.tools.forEach((i) => {
      ...
      i.button.hidden = n, i.button.classList.toggle(K.CSS.conversionToolHidden, n);
    });
  }
  /**
...
const le = new Vo();
var qo = Object.defineProperty, Zo = Object.getOwnPropertyDescriptor, vt = (s, e, t, o) => {
  for (var i = o > 1 ? void 0 : o ? Zo(e, t) : e, n = s.length - 1, r; n >= 0; n--)
    (r = s[n]) && (i = (o ? r(e, t, i) : r(i)) || i);
  return o && i && qo(e, t, i), i;
}, ve = /* @__PURE__ */ ((s) => (s.Opened = "toolbox-opened", s.Closed = "toolbox-closed", s.BlockAdded = "toolbox-block-added", s))(ve || {});
const xt = class extends Ee {
  ...
  destroy() {
    var s;
    super.destroy(), this.nodes && this.nodes.toolbox && (this.nodes.toolbox.remove(), this.nodes.toolbox = null), this.removeAllShortcuts(), (s = this.popover) == null || s.off(me.Close, this.onPopoverClose);
  }
  /**
  ...
  get toolboxItemsToBeDisplayed() {
    const s = (e, t) => ({
      icon: e.icon,
      title: W.t(V.toolNames, e.title || ae(t.name)),
      name: t.name,
      onActivate: () => {
        this.toolButtonActivated(t.name, e.data);
      },
      secondaryLabel: t.shortcut ? Fe(t.shortcut) : ""
    });
  ...
  async insertNewBlock(s, e) {
    ...
    r.call(Z.APPEND_CALLBACK), this.api.caret.setToBlock(i), this.emit("toolbox-block-added", {
      block: r
...
class Go extends T {
  ...
  close() {
    var e;
    this.Editor.ReadOnly.isEnabled || (this.nodes.wrapper.classList.remove(this.CSS.toolbarOpened), this.blockActions.hide(), (e = this.toolboxInstance) == null || e.close(), this.Editor.BlockSettings.close(), this.reset());
  }
  /**
  ...
  enableModuleBindings() {
    ...
    }, !0), oe() || this.eventsDispatcher.on(wt, (e) => {
      var t;
...
var Be = /* @__PURE__ */ ((s) => (s[s.Block = 0] = "Block", s[s.Inline = 1] = "Inline", s[s.Tune = 2] = "Tune", s))(Be || {}), xe = /* @__PURE__ */ ((s) => (s.Shortcut = "shortcut", s.Toolbox = "toolbox", s.EnabledInlineTools = "inlineToolbar", s.EnabledBlockTunes = "tunes", s.Config = "config", s))(xe || {}), yt = /* @__PURE__ */ ((s) => (s.Shortcut = "shortcut", s.SanitizeConfig = "sanitize", s))(yt || {}), re = /* @__PURE__ */ ((s) => (s.IsEnabledLineBreaks = "enableLineBreaks", s.Toolbox = "toolbox", s.ConversionConfig = "conversionConfig", s.IsReadOnlySupported = "isReadOnlySupported", s.PasteConfig = "pasteConfig", s))(re || {}), Ye = /* @__PURE__ */ ((s) => (s.IsInline = "isInline", s.Title = "title", s))(Ye || {}), Et = /* @__PURE__ */ ((s) => (s.IsTune = "isTune", s))(Et || {});
class Ke {
  /**
   * @class
...
class Jo extends T {
  ...
  addConversionToggler() {
    ...
    }), oe() === !1 && be(this.nodes.conversionToggler, W.ui(V.ui.inlineToolbar.converter, "Convert to"), {
      placement: "top",
      hidingDelay: 100
    });
  }
...
class Qo extends T {
  ...
  backspace(e) {
    ...
    tt(i, n) ? this.mergeBlocks(n, i) : o.setToBlock(n, o.positions.END);
  }
  /**
  ...
  delete(e) {
    ...
    tt(i, n) ? this.mergeBlocks(i, n) : o.setToBlock(n, o.positions.START);
  }
  /**
   * Merge passed Blocks
   *
   ...
   */
  arrowRightAndDown(e) {
    const t = J.usedKeys.includes(e.keyCode) && (!e.shiftKey || e.keyCode === B.TAB);
    ...
    (e.keyCode === B.DOWN || e.keyCode === B.RIGHT && !this.isRtl ? this.Editor.Caret.navigateNext() : this.Editor.Caret.navigatePrevious()) ? e.preventDefault() : ge(() => {
  ...
  arrowLeftAndUp(e) {
    if (this.Editor.UI.someToolbarOpened) {
      if (J.usedKeys.includes(e.keyCode) && (!e.shiftKey || e.keyCode === B.TAB))
        return;
    ...
    (e.keyCode === B.UP || e.keyCode === B.LEFT && !this.isRtl ? this.Editor.Caret.navigatePrevious() : this.Editor.Caret.navigateNext()) ? e.preventDefault() : ge(() => {
      this.Editor.BlockManager.currentBlock && this.Editor.BlockManager.currentBlock.updateCurrentInput();
    }, 20)(), this.Editor.BlockSelection.clearSelection(e);
  }
  /**
...
class oi extends T {
  ...
  insert({
    ...
    return r && this.blockDidMutated(it, this.getBlockByIndex(l), {
      index: l
    }), this._blocks.insert(l, c, r), this.blockDidMutated(nt, c, {
      index: l
  ...
  async update(e, t) {
    ...
    return this._blocks.replace(n, i), this.blockDidMutated(st, i, {
      index: n
    }), i;
  }
  /**
  ...
  insertDefaultBlockAtIndex(e, t = !1) {
    ...
    return this._blocks[e] = o, this.blockDidMutated(nt, o, {
      index: e
  ...
  async mergeBlocks(e, t) {
    ...
    q(o) || await e.mergeWith(o), this.removeBlock(t), this.currentBlockIndex = this._blocks.indexOf(e);
  }
  /**
   * Remove passed Block
   *
  ...
  async convert(e, t, o) {
    ...
    const r = await e.exportDataAsString(), a = G(
      r,
      n.sanitizeConfig
    );
...
class ii extends T {
  ...
  copySelectedBlocks(e) {
    ...
    this.selectedBlocks.forEach((n) => {
      const r = G(n.holder.innerHTML, this.sanitizerConfig), a = d.make("p");
...
class we extends T {
   ...
   */
  set(e, t = 0) {
    const { top: i, bottom: n } = m.setCursor(e, t), { innerHeight: r } = window;
...
const Bt = class extends T {
  ...
  async processDataTransfer(s, e = !1) {
    ...
    if ((o.includes ? o.includes("Files") : o.contains("Files")) && !q(this.toolsFiles)) {
    ...
    const l = Object.keys(this.toolsTags).reduce((h, f) => (h[f.toLowerCase()] = this.toolsTags[f].sanitizationConfig ?? {}, h), {}), c = Object.assign({}, l, t.getAllInlineToolsSanitizeConfig(), { br: {} }), u = G(a, c);
   ...
   */
  collectTagNames(s) {
    return Q(s) ? [s] : z(s) ? Object.keys(s) : [];
  }
  /**
  ...
  getFilesConfig(s) {
    ...
    !t && !o || (t && !Array.isArray(t) && (L(`«extensions» property of the onDrop config for «${s.name}» Tool should be an array`), t = []), o && !Array.isArray(o) && (L(`«mimeTypes» property of the onDrop config for «${s.name}» Tool should be an array`), o = []), o && (o = o.filter((i) => zt(i) ? !0 : (L(`MIME type value «${i}» for the «${s.name}» Tool is not a valid MIME type`, "warn"), !1))), this.toolsFiles[s.name] = {
      extensions: t || [],
      mimeTypes: o || []
    });
  }
   ...
   */
  getPatternsConfig(s) {
    s.pasteConfig === !1 || !s.pasteConfig.patterns || q(s.pasteConfig.patterns) || Object.entries(s.pasteConfig.patterns).forEach(([e, t]) => {
   ...
   */
  async processFile(s) {
    const e = jt(s), t = Object.entries(this.toolsFiles).find(([n, { mimeTypes: r, extensions: a }]) => {
  ...
  processHTML(s) {
    ...
    return t.innerHTML = s, this.getNodes(t).map((i) => {
      ...
      if (n.tagName.toLowerCase() === "table") {
        const f = G(n.outerHTML, u);
        n = d.make("div", void 0, {
          innerHTML: f
        }).firstChild;
      } else
        n.innerHTML = G(n.innerHTML, u);
...
class ci extends T {
  ...
  async save() {
    ...
    try {
      ...
      const n = await Promise.all(i), r = await gt(n, (a) => t.blockTools.get(a).sanitizeConfig);
      return this.makeOutput(r);
    } catch (n) {
      X("Saving failed due to the Error %o", "error", n);
    }
  }
  /**
   * Saves and validates
    ...
    return function(t) {
      ...
      function u(y, x) {
        for (var w = {}, I = [], R = 0; R < y.length; R++) {
          ...
          w[g] = E + 1;
          var O = c(C), S = { css: b[1], media: b[2], sourceMap: b[3] };
          O !== -1 ? (l[O].references++, l[O].updater(S)) : l.push({ identifier: C, updater: _(S, x), references: 1 }), I.push(C);
        }
        return I;
      }
      function h(y) {
...
var fi = Object.defineProperty, gi = Object.getOwnPropertyDescriptor, St = (s, e, t, o) => {
...
class Ze extends Ke {
   ...
   */
  get toolbox() {
    const e = this.constructable[re.Toolbox], t = this.config[xe.Toolbox];
    if (!q(e) && t !== !1)
...
class wi extends T {
  constructor() {
    super(...arguments), this.isMobile = !1, this.contentRectCache = void 0, this.resizeDebouncer = Ut(() => {
      this.windowResize();
    }, 200);
  }
  /**
...
class Ei {
  ...
  set configuration(e) {
    ...
    }), this.config.inlineToolbar = this.config.inlineToolbar !== void 0 ? this.config.inlineToolbar : !0, (q(this.config.data) || !this.config.data.blocks || this.config.data.blocks.length === 0) && (this.config.data = { blocks: [t] }), this.config.readOnly = this.config.readOnly || !1, (o = this.config.i18n) != null && o.messages && W.setDictionary(this.config.i18n.messages), this.config.i18n.direction = ((i = this.config.i18n) == null ? void 0 : i.direction) || "ltr";
  }
  /**
